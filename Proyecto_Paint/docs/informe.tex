...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img/conexiones_fisicas.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{img/protocolo_ps2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/protocolo_uart.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/datapath_uart.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/flujo_arduino_fpga.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/datapath_arduino_fpga.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{img/diagrama_estados_uart_arduino.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{img/flujo_logica_pantalla.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/datapath_ps2_to_screen.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{img/diagrama_estados_ps2_to_screen.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{img/flujo_lectura_memoria.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{img/datapath_lectura_memoria.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/diagrama_estados_lectura_memoria.png}
